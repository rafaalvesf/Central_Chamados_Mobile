...
<div class="ctexto"> 
    <div class="menuchart">
      <div>
            ...
            <div class="spacemenu" role="group" aria-label="Basic example">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        while($linha = mysqli_fetch_array($consulta_gresponsavel)){
        $setor = $linha['Responsavel_Tecnico'];
        $qtd = $linha['Qtd'];
        ...
        var options = {
          title: 'Chamados por RESPONSAVEL'
        };
