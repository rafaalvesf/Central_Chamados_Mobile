...
<div class="ctexto">
    <p class="h6 ctexto1">CHAMADOS ABERTOS NO MOMENTO</p>
    ...
    <div class="input-group mb-3 spacement padding">
        <form method="post">
            <button type="submit" class="btn btn-secondary left" value="Exibir Fechados" name="mcheckbox">Exibir
                Fechados</button>
        </form>
    ...
    <table class="table table-hover">
		...
		while($linha = mysqli_fetch_array($consulta_chamados2)){
            ...
            echo '<tr><th scope="row">'.$linha['Titulo_Chamado'].'</th>';
            }
            else{
